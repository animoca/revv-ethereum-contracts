...
const implementation = {
  contractName: 'FormulaREVVInventory',
  nfMaskLength: 32,
  name: 'Formula REVV Inventory',
  symbol: 'FREVV',
  revertMessages: {
    // ERC721
  ...
  deploy: async function (deployer) {
    ...
    return artifacts.require('FormulaREVVInventory').new(forwarderRegistry.address, universalForwarder.address, {from: deployer});
  },
...
describe('FormulaREVVInventory', function () {
  this.timeout(0);
