...
const implementation = {
  ...
  deploy: async function (initialHolders, initialBalances, deployer) {
    ...
    return artifacts.require('REVVMotorsportShardMock').new(initialHolders, initialBalances, registry.address, {from: deployer});
  },
};

const [deployer, other] = accounts;

describe('REVVMotorsportShard', function () {
  this.timeout(0);
