...
const implementation = {
  ...
  deploy: async function (initialHolders, initialBalances, deployer) {
    ...
    return artifacts.require('REVVMotorsportCatalystMock').new(initialHolders, initialBalances, registry.address, {from: deployer});
  },
};

const [deployer, other] = accounts;

describe('REVVMotorsportCatalyst', function () {
  this.timeout(0);
