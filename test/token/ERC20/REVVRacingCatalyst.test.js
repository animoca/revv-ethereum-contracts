...
const {shouldBehaveLikeERC20} = require('@animoca/ethereum-contracts-assets/test/behaviors');

const implementation = {
  contractName: 'REVVRacingCatalyst',
  ...
  deploy: async function (initialHolders, initialBalances, deployer) {
    ...
    return artifacts.require('REVVRacingCatalystMock').new(initialHolders, initialBalances, registry.address, {from: deployer});
  },
};

const [deployer, other] = accounts;

describe('REVVRacingCatalyst', function () {
  this.timeout(0);
