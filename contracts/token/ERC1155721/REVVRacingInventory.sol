...
import {IERC165, IERC1155MetadataURI, IERC1155721Inventory, IERC1155721InventoryBurnable, ERC1155721Inventory, ERC1155721InventoryBurnable} from "@animoca/ethereum-contracts-assets-2.0.0/contracts/token/ERC1155721/ERC1155721InventoryBurnable.sol";
import {IERC1155721InventoryMintable} from "@animoca/ethereum-contracts-assets-2.0.0/contracts/token/ERC1155721/IERC1155721InventoryMintable.sol";
import {IERC1155721InventoryDeliverable} from "@animoca/ethereum-contracts-assets-2.0.0/contracts/token/ERC1155721/IERC1155721InventoryDeliverable.sol";
import {IERC1155InventoryCreator} from "@animoca/ethereum-contracts-assets-2.0.0/contracts/token/ERC1155/IERC1155InventoryCreator.sol";
import {BaseMetadataURI} from "@animoca/ethereum-contracts-assets-2.0.0/contracts/metadata/BaseMetadataURI.sol";
import {MinterRole} from "@animoca/ethereum-contracts-core-1.1.2/contracts/access/MinterRole.sol";

// solhint-enable max-line-length

/**
 * @title REVV Racing Inventory.
 */
contract REVVRacingInventory is
    Recoverable,
    ...
    MinterRole
{
    constructor(IForwarderRegistry forwarderRegistry, address universalForwarder)
        ERC1155721Inventory("REVV Racing Inventory", "REVVR")
