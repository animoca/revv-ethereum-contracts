...
/**
 * @title REVV Motorsport Catalysts Token (Polygon version).
 */
contract PolygonREVVMotorsportCatalyst is Recoverable, UsingUniversalForwarding, PolygonChildERC20Burnable, IERC20Mintable, MinterRole {
    constructor(IForwarderRegistry forwarderRegistry, address childChainManager)
        PolygonChildERC20Burnable("REVV Motorsport Catalyst", "CATA", 18, childChainManager)
