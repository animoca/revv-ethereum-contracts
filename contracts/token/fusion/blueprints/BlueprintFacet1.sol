...
import {BaseBlueprintFacet} from "./BaseBlueprintFacet.sol";

contract BlueprintFacet1 is BaseBlueprintFacet {
    ...
    ) BaseBlueprintFacet(cars, revv, cata, forwarderRegistry) {}
